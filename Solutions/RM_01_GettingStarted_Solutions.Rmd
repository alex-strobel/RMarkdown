...
if (slm$coefficients[2,4]>=.001) { pval = paste0("= ",apa.coef(slm$coefficients[2,4],gt1=F,digits=3)) } else { pval = "< .001" }
# classification of p-value
if (slm$coefficients[2,4] < .05) { psig="significantly"} else {psig="nonsignificantly"}
